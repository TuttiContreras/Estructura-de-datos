...
// Uso: Ordenamiento<T>::ordenamientoQuickSort(arreglo, Ordenamiento<T>::asc/desc, 0, N-1)
template <class T>
...
// Uso: Ordenamiento<T>::ordenamientoMergeSort(arreglo, Ordenamiento<T>::asc/desc, 0, N-1, N)
template <class T>

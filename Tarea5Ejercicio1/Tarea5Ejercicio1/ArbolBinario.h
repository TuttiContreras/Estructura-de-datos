...
public:
    ...
    ArbolBinario<T> * arbolSumas(ArbolBinario<T>*);
    void arbolSumas(ArbolBinario<T>*, NodoB<T>*, NodoB<T>*);
...
//template <class T>
//ArbolBinario<T> * ArbolBinario<T>::arbolSumas(ArbolBinario<T>* original){
//    ArbolBinario<T>* nuevo = new ArbolBinario(original->suma());
//    arbolSumas(original, nuevo->getRaiz(), original->getRaiz());
//    return nuevo;
//}
//
//template <class T>
//void ArbolBinario<T>::arbolSumas(ArbolBinario<T>* original, NodoB<T>* papa, NodoB<T>* father){
